...
import { Button, Container, Form, Col, Dropdown, Row } from 'react-bootstrap'
                ...
                <Container>
                    <Form onSubmit={this.props.handleSubmit}>
                        ...
                        <Form.Group as={Row}>
                            ...
                            <Col sm="6">
                                <select class="form-control" name="member_id" value={currentMemberObject[0].id} label={currentMemberObject[0].name} required onChange={event => this.props.handleChange(event)}>
                        ...
                        <Form.Group as={Row}>
                            <Form.Label column sm="2">Additional Info:</Form.Label>
                            <Col sm="6">
